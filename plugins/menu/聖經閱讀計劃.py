...
class BibleReadingPlan(QWidget):
    ...
    template = {
        ...
        227: [False,
              '歷代志下 2, 歷代志下 3, 歷代志下 4, 歷代志下 5:1, 1 '
              'Corinthians 9:19-27, 哥林多前書 10:1-13, 詩篇 97:1-12'],
        228: [False,
              '歷代志下 5:2-14, 歷代志下 6, 歷代志下 7:1-10, 1 '
              'Corinthians 10:14-33, 哥林多前書 11:1, 箴言 20:5-14'],
        229: [False,
              '歷代志下 7:11-22, 歷代志下 8, 歷代志下 9, 哥林多前書 '
              '11:2-34, 詩篇 98:1-9'],
        230: [False,
              'Song 1, Song 2, Song 3, Song 4, 哥林多前書 12:1-26, 詩篇 99:1-9'],
        231: [False,
              'Song 5, Song 6, Song 7, Song 8, 哥林多前書 12:27-31, 哥林多前書 '
              '13:1-13, 詩篇 100:1-5'],
        232: [False,
        ...
        240: [False,
              '歷代志下 31:2-21, 歷代志下 32, 歷代志下 33:1-20, 2 '
              'Corinthians 1:23, 哥林多後書 2:1-11, 箴言 21:5-16'],
        241: [False,
              '歷代志下 33:21-24, 歷代志下 34, 歷代志下 35:1-19, 2 '
              'Corinthians 2:12-17, 哥林多後書 3:1-6, 詩篇 104:1-18'],
        242: [False,
        ...
        282: [False,
              '耶利米書 18, 耶利米書 19, 耶利米書 20, 帖撒羅尼迦前書 1, 1 '
              'Thessalonians 2:1-16, 詩篇 119:1-8'],
        283: [False,
              '耶利米書 21, 耶利米書 22, 耶利米書 23:1-8, 帖撒羅尼迦前書 2:17-19, 1 '
              'Thessalonians 3, 詩篇 119:9-16'],
        284: [False,
    ...
    def setupVariables(self):
        ...
        if self.todayNo > 365:
            self.todayNo = 365
        self.progressFile = os.path.join(os.getcwd(), "plugins", "menu", "聖經閱讀計劃.txt")
    ...
    def setupUI(self):
        ...
        readingListLayout.addWidget(QLabel("聖經閱讀計劃"))
    ...
    def translateIntoTraditionalChinese(self):
        import copy, pprint
