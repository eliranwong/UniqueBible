translation = {
    ...
    "ttsChineseAlwaysCantonese": "Option to use Chinese voice for reading Chinese text.",
    ...
    "openOnNewWindow": "Open on New Window",
