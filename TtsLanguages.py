...
class TtsLanguages:
    ...
    isoLang2qlocaleLang = {
        ...
        "sv": QLocale(QLocale.Swedish, QLocale.Sweden),
        #"": QLocale(QLocale.French, QLocale.Canada),
        "de": QLocale(QLocale.German, QLocale.Germany),
        "he": QLocale(QLocale.Hebrew, QLocale.Israel),
        "id": QLocale(QLocale.Indonesian, QLocale.Indonesia),
        "en-gb": QLocale(QLocale.English, QLocale.UnitedKingdom),
        #"": QLocale(QLocale.Spanish, QLocale.Argentina),
        #"": QLocale(QLocale.Dutch, QLocale.Belgium),
        "ro": QLocale(QLocale.Romanian, QLocale.Romania),
        ...
        "th": QLocale(QLocale.Thai, QLocale.Thailand),
        #"": QLocale(QLocale.English, QLocale.Australia),
        "ja": QLocale(QLocale.Japanese, QLocale.Japan),
        "sk": QLocale(QLocale.Slovak, QLocale.Slovakia),
        "hi": QLocale(QLocale.Hindi, QLocale.India),
        "pt": QLocale(QLocale.Portuguese, QLocale.Brazil),
        "ar": QLocale(QLocale.Arabic, QLocale.SaudiArabia),
        "hu": QLocale(QLocale.Hungarian, QLocale.Hungary),
        # Use zh-cn for Taiwan Chinese, Taiwanese speaks Mandarin instead of Cantonese
        #"zh-tw": QLocale(QLocale.Chinese, QLocale.Taiwan),
        # we use grc here instead of el
        "grc": QLocale(QLocale.Greek, QLocale.Greece),
        "ru": QLocale(QLocale.Russian, QLocale.Russia),
        #"": QLocale(QLocale.English, QLocale.Ireland),
        "no": QLocale(QLocale.NorwegianBokmal, QLocale.Norway),
        #"": QLocale(QLocale.English, QLocale.India),
        "da": QLocale(QLocale.Danish, QLocale.Denmark),
        "fi": QLocale(QLocale.Finnish, QLocale.Finland),
        "zh-tw": QLocale(QLocale.Chinese, QLocale.HongKong),
        #"": QLocale(QLocale.English, QLocale.SouthAfrica),
        "fr": QLocale(QLocale.French, QLocale.France),
        "zh-cn": QLocale(QLocale.Chinese, QLocale.China),
        "nl": QLocale(QLocale.Dutch, QLocale.Netherlands),
        "tr": QLocale(QLocale.Turkish, QLocale.Turkey),
        "ko": QLocale(QLocale.Korean, QLocale.SouthKorea),
        "pl": QLocale(QLocale.Polish, QLocale.Poland),
        "cs": QLocale(QLocale.Czech, QLocale.CzechRepublic),
    }