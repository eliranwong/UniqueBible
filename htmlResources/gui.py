...
class MainWindow(QMainWindow):
    ...
    def create_menu(self):
        ...
        menu3.addSeparator()
        menu3.addAction(QAction("Too&l Window [Resize / Hide]", self, shortcut = "Ctrl+L", triggered=self.parallel))
        menu3.addAction(QAction("Li&ghtning Window [Show / Hide]", self, shortcut = "Ctrl+G", triggered=self.instant))
        menu3.addSeparator()
    ...
    def setupToolBar(self):
        ...
        backButton.setToolTip("Previous Main Window's History Record")
        ...
        mainHistoryButton.setToolTip("Main Window's History")
        ...
        forwardButton.setToolTip("Next Main Window's History Record")
        ...
        instantButton.setToolTip("Show / Hide Lightning Window")
        ...
        self.enableInstantButton.setToolTip("Enable / Disable Lightning Features")
        ...
        studyBackButton.setToolTip("Previous Tool Window's History Record")
        leftButtonFile = os.path.join("htmlResources", "left.png")
        ...
        studyHistoryButton.setToolTip("Tool Window's History")
        ...
        studyForwardButton.setToolTip("Next Tool Window's History Record")
        rightButtonFile = os.path.join("htmlResources", "right.png")
        ...
        parallelButton.setToolTip("Resize / Hide Tool Window")
    ...
    def setupSecondToolBar(self):
        ...
        searchBibleButton.setToolTip("Search Main Window's Bible")
        ...
        searchBibleButton = QPushButton()
        searchBibleButton.setToolTip("Search Main Window's Bible with OHGB")
        ...
        self.mainRefButton.setToolTip("Tool Window's Bible Menu")
        ...
        openChapterNoteButton.setToolTip("Notes on Main Window's Chapter")
        ...
        openVerseNoteButton.setToolTip("Notes on Main Window's Verse")
        ...
        searchStudyBibleButton.setToolTip("Search Tool Window's Bible")
        ...
        searchStudyBibleButton = QPushButton()
        searchStudyBibleButton.setToolTip("Search Tool Window's Bible with OHGB")
        ...
        self.studyRefButton.setToolTip("Tool Window's Bible Menu")
        ...
        openChapterNoteButton = QPushButton()
        openChapterNoteButton.setToolTip("Notes on Tool Window's Chapter")
        openChapterNoteButtonFile = os.path.join("htmlResources", "noteChapter.png")
        openChapterNoteButton.setIcon(QIcon(openChapterNoteButtonFile))
        ...
        openVerseNoteButton = QPushButton()
        openVerseNoteButton.setToolTip("Notes on Tool Window's Verse")
        openVerseNoteButtonFile = os.path.join("htmlResources", "noteVerse.png")
        openVerseNoteButton.setIcon(QIcon(openVerseNoteButtonFile))
...
class CentralWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.instantView.setHtml("<u><b>Lightning Window</b></u><br>This small window is designed for viewing instant information, with mouse hovering over verse numbers, tagged words and links.", baseUrl)
