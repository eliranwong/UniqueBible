...
class RemoteHttpHandler(SimpleHTTPRequestHandler):
    ...
    def indexPage(self):
        ...
        html = """
            ...
            <head>
                ...
                <link id='theme_stylesheet' rel='stylesheet' type='text/css' href='css/{9}.css?v=1.006'>
                <style>
                ::-webkit-scrollbar {4}
                  display: none;
                {5}
                ...
                <link id='theme_stylesheet' rel='stylesheet' type='text/css' href='css/http_server.css?v=1.006'>
                <link id='theme_stylesheet' rel='stylesheet' type='text/css' href='css/custom.css?v=1.006'>
                <script src='js/common.js?v=1.006'></script>
                <script src='js/{9}.js?v=1.006'></script>
                <script src='w3.js?v=1.006'></script>
                <script src='js/http_server.js?v=1.006'></script>
                <script>
    ...
    def wrapHtml(self, content, view="", book=False):
        ...
        html = ("""<!DOCTYPE html><html><head><title>UniqueBible.app</title>
                ...
                "{8} {9}</style>"
                "<link id='theme_stylesheet' rel='stylesheet' type='text/css' href='css/{7}.css?v=1.006'>"
                "<link id='theme_stylesheet' rel='stylesheet' type='text/css' href='css/custom.css?v=1.006'>"
                "<script src='js/common.js?v=1.006'></script>"
                "<script src='js/{7}.js?v=1.006'></script>"
                "<script src='w3.js?v=1.006'></script>"
                "<script src='js/http_server.js?v=1.006'></script>"
                """<script>
                ...
                "<script src='js/custom.js?v=1.006'></script>"
