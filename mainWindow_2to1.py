...
from PySide2.QtWidgets import (QGridLayout, QApplication, QDesktopWidget, QHBoxLayout, QLineEdit, QMainWindow, QPushButton, QToolBar, QWidget)
...
class MainWindow(QMainWindow):
    ...
    def parallel(self):
        if self.parallelMode == 1:
            self.centralWidget.layout.setColumnStretch(1, 100)
            self.centralWidget.layout.setColumnStretch(2, 0)
            self.centralWidget.webEngineView2.hide()
            self.parallelMode = 0
        elif self.parallelMode == 0:
            self.centralWidget.layout.setColumnStretch(1, 20)
            self.centralWidget.layout.setColumnStretch(2, 10)
