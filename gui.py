...
class MainWindow(QMainWindow):
    ...
    def create_menu(self):
        ...
        menu4.addAction(QAction("Smart Indexes", self, shortcut = "Ctrl+*", triggered=self.runINDEX))
        menu4.addAction(QAction("Commentary", self, shortcut = "Ctrl+%", triggered=self.runCOMMENTARY))
        menu4.addSeparator()
        ...
        menu4.addSeparator()
        menu4.addAction(QAction("Compare All Versions", self, shortcut = "Ctrl+&", triggered=self.runCOMPARE))
