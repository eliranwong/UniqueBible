...
#        self.leftToolBar.addWidget(actionButton)
    ...
    def installMarvelBibles(self):
        bibles = {
            ...
            "Chinese Union Version (Traditional Chinese)": ((config.marvelData, "bibles", "CUV.bible"), "1iqsHxOWD_H-BABbjq03qIIrTu8u-UyjJ"),
            "Chinese Union Version (Simplified Chinese)": ((config.marvelData, "bibles", "CUVs.bible"), "1neY4KK3tfVtmnoLQu6YVMCyIhqcFEiPZ"),
    ...
    def installMarvelDatasets(self):
        datasets = {
            "Core Datasets": ((config.marvelData, "morphology.sqlite"), "1Vn3UXicjqDQSA41ek3_zJ7n2iAlspU_3"),
            ...
            "Cross-reference Data": ((config.marvelData, "cross-reference.sqlite"), "1gZNqhwER_-IWYPaMNGZ229teJ5cSA7My"),
            ...
            "Atlas, Timelines & Books": ((config.marvelData, "books", "Timelines.book"), "1nuhrsujL6LYYeviaT22Rhn_wk9kc6una"),
