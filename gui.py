...
class MainWindow(QMainWindow):
    ...
    def create_menu(self):
        ...
        menu7.addAction(QAction("&Active Chapter Note", self, triggered=self.openMainChapterNote))
        menu7.addAction(QAction("&Active Verse Note", self, triggered=self.openMainVerseNote))
        menu7.addSeparator()
        ...
        menu7.addAction(QAction("&Open Other Files", self, triggered=self.openTextFileDialog))
        menu7.addSeparator()
        menu7.addAction(QAction("&Paste from Clipboard", self, shortcut = "Ctrl+^", triggered=self.pasteFromClipboard))

        menu8 = self.menuBar().addMenu("&Builder")
        menu8.addAction(QAction("&Tag References in a File", self, shortcut = "Ctrl+%", triggered=self.tagFile))
        menu8.addAction(QAction("&Tag References in Multiple Files", self, shortcut = "Ctrl+&", triggered=self.tagFiles))
        menu8.addAction(QAction("&Tag References in a Folder", self, shortcut = "Ctrl+*", triggered=self.tagFolder))

        menu9 = self.menuBar().addMenu("&About")
